...
class Form5Page extends StatefulWidget {
  ...
  Form5Page({required this.tagNumber});

  @override
  _Form5PageState createState() => _Form5PageState();
}
...
class _Form5PageState extends State<Form5Page> {
  ...
  Future<void> appendRow() async {
    ...
    // Prepare the data to pass to the ReviewPage
    final data = {
    ...
    try {
      ...
      final shouldSend = await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => ReviewPage(
            ...
            appendUrl: "https://esheapp.in/esheapp_php/append_new_row.php", // URL for appending data
          ),
        ),
      );
      ...
      if (shouldSend == true) {
        // Data successfully sent, reset the form
        _resetForm();
        ScaffoldMessenger.of(context).showSnackBar(
