...
import 'package:eshefireapp/UserDetailsScreen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: DashbordAdminpage(),
    );
  }
}

class DashbordAdminpage extends StatefulWidget {
  @override
  _DashbordAdminpageState createState() => _DashbordAdminpageState();
}

class _DashbordAdminpageState extends State<DashbordAdminpage> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              Container(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(30), // Match button radius to container
                      ),
                      padding: EdgeInsets.symmetric(horizontal: 20, vertical: 15), // Adjust padding
                    ),
                    child: Text(
                ...
                Center(
                  child: Column(
                    mainAxisSize: MainAxisSize.min, // Centers the button and padding together
                    children: [
                      Container(
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            padding: EdgeInsets.symmetric(vertical: 12.0, horizontal: 60.0), // Button padding
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(30.0), // Match button radius to container
                            ),
                            backgroundColor: Colors.transparent, // Transparent to show gradient
                            shadowColor: Colors.transparent, // Remove default shadow
                          ),
                      ...
                      SizedBox(height: 100), // Add padding below the button
                    ],
                  ),
                ),
